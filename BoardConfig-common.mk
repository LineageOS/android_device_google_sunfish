...
# Note as of b/208358685, our sunfish_tuscany builds are
# exceeding the super partition limit, causing all builds
# to fail. Here we increase it by 200 MB to keep building.
ifeq (,$(filter-out sunfish_tuscany, $(TARGET_PRODUCT)))
BOARD_SUPER_PARTITION_ERROR_LIMIT := 9431663104
endif
